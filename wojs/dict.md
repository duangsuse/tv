...
for z in (Z.ZipFile(u,'r') for u in glob('*.zip')):
...
KuberNetes 酷播垒体👯‍♀️ k(8char)s，也叫cube，把[豆荚Pod]稻壳儿广播到集群部署！ GreFana 可用于监视uptime
...
- cache快取🔑 lazyCOW慢取🔑 buffer闪存🔑/截取加载(高时延换低延时;bash dd bs=1KB)
...
- (C#)dnSpy (JA)BytecodeViewer [UnityStudio](https://www.perfare.net/archives/763) (GL)RenderDoc (Flash)[JPEXS](https://github.com/jindrapetrik/jpexs-decompiler)
...
- ERP 企业雇员资源管理，电子HR、(对公toB电商 E-business)等，如金碟、拥有
- DBMS Postgres.org 或 MySQL.com ，前者支持自增ID等特性
- UX User eXperience，产品经理，负责跨页部分
- DNN ML的一种说法，见[tf web](https://playground.tensorflow.org/), [th game](https://store.steampowered.com/app/1702550/_/?l=schinese)
- pooling layer “池化层”，谱邻层/马赛克层，减少网络参数，稳定CNN图像平移不变性
- CDN 静态内容代理，在墙内大概会减速吧
- DevOps 提升(DX dev eXperience)的方法论和工具，例如自动化测试/发布流水线 CI/CD
- IoT物联网 RPA按键精灵 VM虚拟机多开 JIT运行时(优化)编译
- EDA 一类电子电路CAD工具，比 Verilog/VHDL/FPGA 还低一级，大概比光刻机低级吧
- DMCA 响应投诉，不断试图屏蔽 youtube-dl; zlib.org 以及添加DRM反盗版的USA机构
- ICANN 网址分配机构 IANA.Org 的上属，但 cn,top 等TLD域名则是世界各地政府管理，参考[罗永浩的破产史](https://www.williamlong.info/archives/1654.html)。 为啥网民最多的China却没掌握[DNS Roots](https://root-servers.org/)？被美国卡了脖子？ 答：因为太强 **单方面删除了youtube,wiki等等“墙外实体清单”。**
- https://cpwp.netlify.app/; https://github.com/shimohq/chinese-programmer-wrong-pronunciation 本文参考

### 术语缩写

- PaaS 基本上是DB-as-service的扩展版，免于配置VPS的麻烦。 github.io 就是静态站的PaaS
- SaaS 基本上是开源软件的付费服务，例如3D建模 Blender.org 的云协作、云渲染
- IaaS 例如，GPT API 和它的人格市场
- DHCP(Dynamic Host Configuration Protocol) 局域网 `ip a;ip r` 地址分配
- SFTP 通过SSh(`TLS.socket(IP:22).Shell`)转发ftp的端口，从而让1:1复制更容易。 FTP的一个更知名版本是MTP，而HTTP支持动态生成的文件，但默认不能修改文件树
...
> 国内义务教育课本有「防自学」「防开放性思考」等有意无意的坏设计，配合电视报纸时甚至会出现"对立统一"式自相矛盾的逻辑误区，在许多堂堂正正的中国人长大后，就埋下了情绪化的敏感瓷，与饭圈与清真教比，似乎雷同

政治基于人心，经济基于人性，人皆生而有之。你可以不参与，但不懂会吃大亏。
...
它的历史终结是 无社会-主义，无人民-政府，有了《新阶级》总工会，没了通往奴隶主之路：人民日报日人民，国家干部干国家，民主们霸占经济主权，天才们排挤天生之材

左派四问
1. 工农晋升的指标由谁来“投票”？ 老板是0号员工，你为啥不干？为何财阀学阀不愿赚你利息？ 为何你们只愿互称“同质”呢？筛选性教育真平等啊！
2. 剥夺自产自有权，是不是压迫？ “房医校老劳”资源，强卖强买，是人权兜底还是专权特供？ 户口的“签证”由谁发，赚到的粮票布票由谁“换汇”？
3. 生产资料要不要调整折旧研发换代？ 秋收“剩余”的谷种是该全吃了，还是该撒出去“扩张”职缺缩小价差？ 该请本行人入股，还是被外地人计划？？
4. “左派”科学是给普罗大众，还是给先锋队造神？ 技术革命是开源共创真善美，还是抢夺死钱活投机？ 历史悲剧若无愧于民，问不问责修不修正？！

马列三疑
1. 共产共有分什么？你老板赚不回发出的工资，供销关系会怎样？ `价=(需/供)×值质` ，富人阶层走极端内卷或通涨好受，还是买劳权工会的账，将供应链闭环好受？ 
2. 国际主义送什么？“中朝俄伊哈”就是国际？是美帝用全球供应链剥削非酋，还是非酋用闭关锁国压迫军民、伊朗用官僚教条“殖民”女性、忠国给白鹅黑爹超国民待遇？
3. 平等自由保什么？福利亏欠和商品滞销，有无关系？ 八股考公和兴亡周期率，有何趋势？ 国家集资和权贵资本主义，谁能平衡？ 是公开财税立法权，再操控51%新媒体、联合51%经济计划有罪，还是凭泡沫资产，坐庄120%(20点赤字)的“政经摊位”的双轨制垄断队有错？？

以上是纯经济领域，生产4项=关系分配资料要素+价值3项=本地国际可持续，是现代生活的常识共识了，而你们的教义和信仰的空头支票，和“吃亏是福”等赤字捆绑太深、粉饰太平，在人性上流通不起，扩张不来吧！

或许靠资本合作双赢是伪命题，「莫斯科不相信眼泪」，但双输在战争史上经常发生。 一位母亲的孩子远渡重洋，以仇杀另一位自己素昧平生的有妻女的老公为最高荣耀。 一群刚辞职的建筑工人，让科学家们花十年的心血设计的迫击炮，和流传千年的名胜古迹同归于尽。 国家牺牲了未来，科学失去了劳力和智慧，人民毁灭了遗产和世风，你吃我的毒奶粉，我住你的烂尾楼。 那些贩卖谎言和恐怖，转移仇恨的法西斯社达们，那些在生命和自由中「自由选择」的圣人，怎么不自己先死一死？

“大东亚共荣没问题，问题是谁共荣谁，谁平等谁，谁共谁的产”？
- 美国发展，是靠抢夺，澳洲繁荣，是靠煤矿，但上面有一个既爱抢又有矿的联盟：饿国。它为啥比中国还穷？ 人民不向钱看，所以穷。宁吃共产胜草不食资本败肉？肉食者，何时真心吃草呀
...
- 外汇钞票、监督选票、平等传票、福利税票
- 预防暴力、限制权力、制衡财力，财保智力
- 立法正义、司法平等，行政透明，股债期券 (三民主义的民选三公原则)
- 共产要一国圣人，君主要一位神人，专政要一群圣人，民主不牺牲圣人。“圣人”不该是圣人的墓志铭。
- 记住历史，因为战争毁了我们的过去，忘记仇恨，因为你无权毁掉孩子的未来。不同的认知心态决定相同民族的上限与安心感。

九月劳权十月专政证明，[列宁是对的，马克思错了，1991的苏联说他俩都错了](https://theinitium.com/zh-hans/series/communism-debate)，历史终结论和AI乌托邦提前到来了。 现在乱讲 iPhone/OURphone, u don't vote gov, gov votes u 的“苏联笑话”合订本，也都是在欧美日韩文化点出的科技树下。
战争反美和平，自由霸权奴役，无知忠诚力量，这样对科学规律指鹿为马的双重傲慢，必然迎来二次失败，统治阶级必然死而不亡。那些因庚子俄难，因海参崴港口被侵略五筒的人，终于能安息了。

经而不济，法而不制，民族有主。
民主立法都不用说，俩兔子分萝卜，先分的后选，这叫“公平不分主客”，何况买称还要拿兔子的税？ 中体西用就是僵化，上下都玩腻后，如官能衰竭无疾而终。
没有消费型社会是买得起“棺材本” 卖得到“血汗钱”的，恒产者心恒，赎身税的储蓄本身就是经济危机，它撑不到兑现。脑子有坑的海绵人是会吸水的！ 外需和土木更没法恢复，除非利食阶层无私。无私怎么挤得进去？ 空载增速5%的三架马车。

批判性思维吧！ 景德镇出来的，浑身敏感瓷儿才多。质疑的歪脑筋才是科技之母。
溯本追源，玻璃心、封建、“人肉电池”为何相似？ 遇到教科书外的观点便破防删封。应对创造性破坏只需垄断污蔑。想修长城时逼海量奴工高智底价。 
感染了这么一种反智的鸵鸟思维定式和路径依赖，“愚弱疲辱贫掠壹”，仁义礼智信父子，哪一面，才是底色呢？
...
- 辩证法逻辑：二分法+合题(对立统一)，客观“唯物”是复杂的，正反合三者均取决于主观的价值或立场。 原创为黑格尔的绝对意志。 爱翁：“逻辑带着你A->B, 创造力从A带你去任何地方”, 辩证提醒你A->(B|C)。
  - 诱导关注、诱导回答(操纵聚光灯-跳针/操纵天平)，惯用的媒体诡辩法。 Robert议事规则的12条: 机会均等，不质疑动机-疑罪从无， 发言完整-限时限次，  一时一件-不转移话题-不“跟着闯红灯”
  - 神存原理： 全知+全能+全善 的唯一不存在。 祂漠视Python引诱女人吃禁果->不全知/不全善 二选一； 祂造不出自己的矛刺不破的盾-> 不全能/跨时轴不唯一 二选一
  - 但，无神论(奥卡姆剃刀:勿增实体)并不能证明祂不存在，证据总是不足。这些矛盾-地圆地心论-DNA进化论-物理世界-可以轻松被辩经「大而化之」：“祂一定全知全善，你是观测时间不够长”
  - AB岛脑筋急转弯：A岛只说实话，B岛只说谎话，当你问“这里是A(or B)吗”，总是负负得正(排中律，贬义二极管)。 这时问 'true or 1=1' 即可突破诱导回答
  - 无限猴子定理： 黑猩猩在其一生中成功输入“bananas”这个词的几率为 5%，而 "I chimp, therefore I am" ——是 1000 万亿分之一。即使每秒一只也能数到宇宙的尽头。 药物毒性(LD50%) 也常用食盐与水的毒性做界限区分
  - 信仰间非此即彼的“圣战”是科学伦理要避免的。 不可证伪的自恰公理也含有数学、法律、逻辑。 逻辑符号是种“存在”，还是种经验？不可知论并非一种需证明的存在，它，就是价值观和真理。谁证明过不证即无？ 若是对概率对权钱名有信仰，有把人等价为一堆分子的“不迷信”，甚至于禁止“灵魂”等哲学文学，那也配叫信仰吗？ 那会令现代文明毛骨悚然。 那求神拜活佛不是信仰，是狂妄和行贿。着实缺是政治无神论，和尊重孔庙祈福以外的多神论。
  - 一些经济指标模型：天时地利人和；纵有千古，恒有八荒；
- 资本主义：根植于以机会公平、程序正义，修正财富平均、情绪正义，缺点是无法遏制贫富差距(基尼系数)终致大萧条等内循环危机。 其前身是雅典人的自由主义，后继是美加左右党派的「社会民主/社会自由主义」。注意！！社民只是左派，并非共产主义预言里的垄断专政政府。历史上，全无产vs全财阀的圣战，也只是穷人联合中产/小资的漫长抗争。
- 共产主义：上世纪 **欧洲犹太人马克思** 借无神论哲学+科学经济学科普为风口，以工人晋升和零元购为教义，创立的逆拜金、仇恨教育、血统论与集体主义无政府大IP，与同名党派天差地别。 白左不批评马克思，因为他们也先建工会后维权，白左反共，因为他们视垄断为敌。 [人间并非只有马左在践行乌托邦](https://www.youtube.com/watch?v=LKgoSyv2u5U)，却少有以科学唯物宣传，为草菅人命借口的，[《新阶级》](https://iayod.github.io/2020/03/23/xue-xi-gong-chan-zhu-yi-de-yi-xie-zi-yuan/)的帝国主义下“波波”独裁者们的[枕边书](https://github.com/HarborLibrary/Political-Science)。
- 永生、纯能量、宇宙的尽头和终结：有需求，问题很好解决，想让人轻生少生，苦难必不少你。 匮乏从不是问题，让执行者3选1即可：永生绝育(社会抚养化)、正常生育、太空殖民，而破产为税更适合当下承载力。 没有无限的时间解决不了的问题。现代社会生育和性已经脱钩，婚姻亲戚和家产遗产也越来越自由，这些生死大事都是对科学伦理的挑战。

## 编程名言

> 本页的所有名言不保证是「原汁原味」。古板客套的翻译，更应该是被刻在石头上吧？

“大多数优秀的程序员干这一行，不是因为他们期望获得报酬或讨好客户（更不是为宏大目标和无偿奉献），而是他们认为编程是一件很快乐的、值得分享的事情——Linus, 就像gcc之父RMS”
“伟大的车工值得给他几倍于普通车工的薪水，但一个能创作伟大软件的写手，其价值则要等同于一个普通程序员的1万倍——Gates”
“代码胜于雄辩。——Linus”
...
“一千行代码，莫视为你产出的行数，那是你花费的行数——Dijkstra, [SSSP普遍最优解](https://clementmihailescu.github.io/Pathfinding-Visualizer), FFmpeg v7向他致敬”
...
“计算机没什么用。他们只告诉你答案。——毕加索”
“自己谷歌——C&UNIX之父Ken&Ritchie TS&C# 之父Hejlsberg”
“程序必须首先让人类知道是啥，然后顺便向机器解释咋执行——《SICP》”
“你自己的代码如果超过6个月不看，再读起来就像看别人写的——伊格尔森定律”
“好的代码字面就是最好的文档。代码永不说谎；注释有时会。——《代码大全》和XP极限编程”
“编程语言是我的母语。我的课题不是懂不懂，是已知和未知，因为，我以重复前人的成绩和缺陷为耻。”
“编程语言是我的母语。编程界最深奥的代码，是写出来前，就能在头脑里运行的那些——人肉编译器play是吧”
“如何才能让代码魔法师们相信，简单性和清晰性——数学家所说的“优雅”——不是可有可无的奢侈品，而是决定成功与失败的关键因素？——EWD,P147”
“COBOL和BASIC的使用摧残大脑；其教育应被视为刑事犯罪。作为潜在的程序员，他们已精神残废，失去重塑的机会了！——Dijkstra”
“Java静态的异常和类型，就像中年父母对子女的过度保护和军备赛一样：吃个薯条，先担心会不会噎死，连功能的雏形都还没想好，就要开始区分字典里不能少写什么了——duangsuse”
...
“编程就像sex一样：犯错一时爽，维护火葬场。2038年1月19日，凌晨3点14分07秒，UNIX之父眼里的'直到世界末日'。
  我终于明白‘规范兼容性’是怎么回事了——是指我们得保留所有原有错误！”
  https://zh.wikipedia.org/wiki/Wikipedia:別跟著闖紅燈
  https://zh.wikipedia.org/wiki/Wikipedia:IP用户都是人

“人们常说，伟大的学科就像是站在巨人肩膀上的巨人。而软件产业，正如站在其他侏儒脚上的侏儒。——Alan Cooper，UIUX之父
  计算机软件产业最为惊人的成就，是代码持续不断地放弃硬件产业的惊人成果和稳定性。”

“现在的软件工程，就像金字塔：缺乏先验，靠蛮力和无数奴隶堆砌再补丁而成——Alan Kay, OOP/Smalltalk和GUI/PARC的先知”

- “难者不会。当框架试图解决一个它不理解的问题时，复杂度就产成了。——Andy Boothe”
- “判断力来自经验，但经验来自于错误的判断。——Fred Brooks, 《人月神话》作者，'没有银弹'的架构师”
- “要先系统性可用，然后才可复用——《设计模式》GoF 四人帮之John”
- “设计是一个发现问题，而不是寻求解决方案的过程”—— Leslie Chicoine”

“世界上只有两类编程语言：人们都抱怨的语言和从来没有人使用的语言。——业界大牛Stroustrup，C++之父
  世界上只有两类编程语言：发明解决方案来为编程游戏助兴的玩具语言，和抄袭玩具以添加私货获利的java派语言”

- “当你选择了一种语言，意味着你还选择了一组技术、一个社区。——Joshua Bloch, 没有用过OSon”
- “人生苦短，我用Python——Bruce,《C++/Java編程思想》作者”
- “任何可以使用JavaScript来实现的应用，最终都会使用JS(和它的JSON)来实现——Atwood’s Law”

“大多数人熟知程序员的美德：懒惰、急躁、傲慢。
  计算机语言设计就像是在公园里闲逛。只不过，那个公园是侏罗纪公园。- Larry Wall，Perl 和正则之父”

- “以用户为中心，其它一切纷至沓来——Google 信条”
- “只有两个行业把自己的客户称为‘用户’——软件市场和毒品市场”
- “take actions, the outcome takes care of itself.——Liu Kang - Mortal Kombat 1”
