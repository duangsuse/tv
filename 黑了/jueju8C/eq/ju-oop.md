...
- 亮点>API即示例>测试>代码。编程只是快乐的涂鸦，电脑和“专业”社区只有权让涂鸦等效于生产。职责划分是，app代码简明趋短、信达趋俗
- 不要作为框架说explicit优于implicit。负起穷举用法模型的责任，应追求“不必用=不用学”
...
- 对会设计代码的人来说，想要加的功能越多，易写易记的程度越大。使用频率即正义，无为而作，少即是多
